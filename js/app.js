...
function updateUserDropdown() {
    ...
    // Mostrar botão "Meus Projetos" só para logados
    const projectsBtn = document.getElementById('sidebarProjectsBtn');
    if (projectsBtn) projectsBtn.style.display = user ? 'flex' : 'none';
    ...
    if (user) {
        ...
        dd.innerHTML = `
            ...
            <a href="pages/vscode.html" class="dropdown-item">
